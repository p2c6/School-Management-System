                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0"></h5>
                      <small class="text-muted float-end">Edit professor</small>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="{{ route('professors.update', $professor) }}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="professor_name" id="professor_name" value="{{ $professor->professor_name }}" />
                          </div>
                        </div>
